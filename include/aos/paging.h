...
{
    return paging_map_frame_attr(st, buf, bytes, frame, VREGION_FLAGS_READ_WRITE, arg1,
                                 arg2);
}
                                                 ...
                                                 void *arg2)
{
    ...
    return paging_map_frame_attr(st, buf, id.bytes, frame, VREGION_FLAGS_READ_WRITE, arg1,
                                 arg2);
}
