...
#define TASKCN_SLOT_INIT_AOS_RPC_EP (TASKCN_SLOTS_USER+1)   ///< End Point to init (for aos_rpc)
#define TASKCN_SLOT_MONITOREP       (TASKCN_SLOTS_USER+1)   ///< lrpc endpoint to monitor (for all other domains)
#define TASKCN_SLOT_INIT_CLIENT_EP  (TASKCN_SLOTS_USER+2)   ///< End Point to init (if domain acts as server)
#define TASKCN_SLOT_INIT_SERVER_EP  (TASKCN_SLOTS_USER+3)   ///< End Point to init (if domain acts as server)
